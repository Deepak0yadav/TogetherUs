      ...
      <div className="glass-card purple-glow" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: '#6b7280', fontSize: 14 }}>
            Build a shared pixel world with your partner
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div>
            <label style={{ color: '#9ca3af', fontSize: 12, fontWeight: 500, display: 'block', marginBottom: 6 }}>
              Display name <span style={{ color: '#4b5563' }}>(optional)</span>
            </label>
            <input
              className="gather-input"
              type="text"
          ...
          <button type="submit" className="btn-primary" disabled={loading} id="register-submit" style={{ marginTop: 4 }}>
